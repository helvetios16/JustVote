...
const submitVote = async () => {
  if (!selectedOption.value || !voting.value || !capturedImage.value) {
    modalType.value = 'error';
    modalTitle.value = 'Error de Votación';
    modalMessage.value = 'Por favor, selecciona una opción y toma una foto antes de votar.';
...
const openCameraModal = async () => {
  if (!selectedOption.value) {
    modalType.value = 'error';
    modalTitle.value = 'Error de Votación';
    modalMessage.value = 'Por favor, selecciona una opción antes de abrir la cámara.';
    showModal.value = true;
    return;
  }
